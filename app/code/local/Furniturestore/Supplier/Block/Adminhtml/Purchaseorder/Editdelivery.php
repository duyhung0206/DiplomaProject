...
class Furniturestore_Supplier_Block_Adminhtml_Purchaseorder_Editdelivery extends Mage_Adminhtml_Block_Widget_Form_Container
{
    public function __construct()
    {
        ...
        $this->_mode = 'editdelivery';
        $purchaseOrderId = $this->getRequest()->getParam('purchaseorder_id');
        $this->_updateButton('save', 'label', Mage::helper('supplier')->__('Create Delivery'));
        ...
        $this->_formScripts[] = "
            ...
            function uploadFile() {
                ...
                xhr.open('POST', '".$this->getUrl('adminhtml/sup_purchaseorder/importproductforcreatedelivery')."');
                xhr.send(fd);
           }
    ...
    public function getHeaderText()
    {
        if (Mage::registry('purchaseorder_data')
            ...
            return Mage::helper('supplier')->__("Create New Delivery For Purchase Order No. '%s'",
