...
class Furniturestore_Supplier_Block_Adminhtml_Supplier_Edit_Tab_Products extends Mage_Adminhtml_Block_Widget_Grid {
    ...
    protected function _getSelectedProducts() {
        ...
        if ($productArrays) {
            ...
            foreach ($productArrays as $productArray) {
                Mage::helper('supplier')->parseStr(urldecode($productArray), $supplierProducts);
    ...
    public function getSelectedRelatedProducts() {
        ...
        $productCollection = Mage::getResourceModel('supplier/product_collection')
    ...
    public function getSupplier() {
        return Mage::getModel('supplier/supplier')->load($this->getRequest()->getParam('id'));
    }
