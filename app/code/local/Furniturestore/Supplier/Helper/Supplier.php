...
class Furniturestore_Supplier_Helper_Supplier extends Mage_Core_Helper_Abstract {
...
//    }
    ...
    public function getSupplierInfoBySupplierId($supplierId) {
        ...
        $link = Mage::helper("adminhtml")->getUrl('adminhtml/sup_index/edit', array('id' => $supplierId));
